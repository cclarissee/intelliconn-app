...
export default function SuperAdminAnalytics({ isVisible }: SuperAdminAnalyticsProps) {
    ...
    // Interpolate spinAnim to string format for rotate transform
